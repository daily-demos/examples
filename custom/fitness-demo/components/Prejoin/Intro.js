        ...
        <div className="jc-card">
          ...
          <CardBody>
            {Object.keys(rooms).length === 0 && (
              <p>
                Looks like there&apos;s no class going on right now, start with
                creating one!
              </p>
            )}
            {Object.keys(rooms).map((room) => (
              <div className="room" key={room}>
                <div>
                  ...
                  <span>
                    {`${rooms[room].length} ${
                      rooms[room].length > 1 ? 'people' : 'person'
                    } in class`}
                  </span>
                </div>
          ...
          <div className="jc-card">
            ...
            <CardBody>
              ...
              <Field label="Privacy">
                ...
                <p>
                  {privacy
                    ? 'Public class (anyone can join the class)'
                    : 'Private (attendees will request access to class)'}
                </p>
              </Field>
            </CardBody>
            <CardFooter>
